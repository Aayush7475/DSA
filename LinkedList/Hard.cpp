...
// Cloning List with Random pointer (Method 1) ->
...
Node* connectingNexts(Node* head){
...
Node* cloningRandomLL(Node* head){
    insertCopyNodes(head) ;
    connectingRandoms(head) ;
    return connectingNexts(head) ;
}
